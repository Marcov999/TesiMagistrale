...
La convergenza al bordo uniforme sui compatti è data dalla Corollario \ref{montel}, supponendo che la varietà sia una sottovarietà limitata di $\mathbb{C}^d$. Per dire che la funzione limite è costante, invece, ci serviranno delle ipotesi aggiuntive di tipo geometrico: la condizione di visibilità per le simil-geodetiche.

\begin{defn}
    Sia $X$ una varietà complessa\marginpar{E connessa? Probabilmente serve se vogliamo $\sigma$ a.c. rispetto alla distanza indotta da una metrica hermitiana}; fissiamo $\lambda \ge 1$ e $\kappa \ge 0$. Sia $I\subseteq \mathbb{R}$ un intervallo; una curva $\sigma:I \longrightarrow X$ è detta una \textit{$(\lambda,\kappa)$-simil-geodetica} se
    \begin{enumerate}
...
\begin{defn} \label{visibility}
    Sia $X$ una sottovarietà complessa, connessa e \marginpar{Serve limitata? Da rivedere dopo aver guardato l'articolo sui domini illimitati, ed eventualmente correggere qualche enunciato/eliminare ipotesi non necessarie più avanti}limitata di $\mathbb{C}^d$, e fissiamo $\lambda \ge 1$ e $\kappa \ge 0$. Diciamo che $X$ è \textit{$(\lambda,\kappa)$-visibile} se
    \begin{enumerate}
