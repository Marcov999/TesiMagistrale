...
\marginpar{Capire che controesempio ci serve davvero e trovarlo}
...
\begin{ftt}
    ...
    \begin{nlist}
        ...
        \item i due punti sono entrambi sulla sfera unitaria. Per \cite[Proposition 6]{NTT}, è facile vedere che, se la palla unitaria soddisfa la condizione di visibilità per simil-geodetiche, allora $\Omega$ la soddisfa in questo caso. Adesso, la palla unitaria è Gromov-iperbolica (è facile verificare, ad esempio, che è strettamente pseudoconvessa), \marginpar{Forse qui è più pulito citare BZ e dire che è Goldilock}dunque soddisfa la condizione di visibilità rispetto alle geodetiche. Usando \cite[Part III, Chapter H, Paragraph 1, Theorem 1.7]{BH} e il fatto che è uno spazio metrico proprio, possiamo facilmente concludere che soddisfa anche la condizione di visibilità per le simil-geodetiche.
    \end{nlist}
