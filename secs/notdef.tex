...
\begin{itemize}
    ...
    \item il disco unitario è $\mathbb{D}=\{z \in \mathbb{C} \mid |z|<1\}$, mentre $\mathbb{D}^n=\mathbb{D}\times\dots\times\mathbb{D}$ è il polidisco in $\mathbb{C}^n$ e $\mathbb{D}_r=\{z \in \mathbb{C} \mid |z|<r\}$ è il disco di centro $0$ e raggio $r>0$;
...
\begin{proof}
    ...
    \end{align*}
    e sia $A_Y\big(f(x);\diff f_x(Z)\big)$ definito analogamente. Dato $v\in A_X(x;Z)$, prendiamo $g\in\text{Hol}(\mathbb{D},X)$ tale che $g(0)=x$ e $\diff g_0(v)=Z$. Allora $(f\circ g)(0)=f(x)$ e $\diff(f\circ g)_0(v)=(\diff f_x\circ\diff g_0)(v)=\diff f_x(Z)$; dunque $v \in A_Y\big(f(x);\diff f_x(Z)\big)$. Quindi $A_X(x;Z)\subseteq A_Y\big(f(x);\diff f_x(Z)\big)$ e la tesi segue dalle definizioni di $K_X$ e $K_Y$.
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &\text{e }\varphi_j(\zeta_j)=\varphi_{j+1}(\zeta_j)\text{ per }j=1,\dots,m-1\Bigg\},
    \end{align*}
    e sia $A_Y\big(f(x),f(y)\big)$ definito analogamente. Dati punti $\zeta_0,\dots,\zeta_m \in \mathbb{D}$ e funzioni $\varphi_1,\dots,\varphi_m\in\text{Hol}(\mathbb{D},X)$ che realizzano $\displaystyle\sum_{j=1}^m \omega(\zeta_{j-1},\zeta_j)$ in $A_X(x,y)$, si verifica immediatamente che $\zeta_0,\dots,\zeta_m \in \mathbb{D}$ e $f\circ\varphi_1,\dots,f\circ\varphi_m\in\text{Hol}(\mathbb{D},Y)$ realizzano lo stesso numero in $A_Y\big(f(x),f(y)\big)$. Quindi $A_X(x,y)\subseteq A_Y\big(f(x),f(y)\big)$ e la tesi segue dalle definizioni di $k_X$ e $k_Y$.
\end{proof}
