...
\end{defn}
 ...
 Ci servirà il seguente risultato per un controesempio. (ANCHE QUI, COME SOTTO: FATTO O TEOREMA? INSERIRE CIT)
 \begin{ftt}
    Ogni dominio pseudoconvesso è un dominio di olomorfia.
 \end{ftt}
