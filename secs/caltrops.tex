...
\begin{defn}
    ...
    \begin{itemize}
        \item il sottoinsieme del bordo $\partial\Omega\setminus\{q_1,\dots,q_N\}$ è $C^2$ e strettamente pseudoconvesso, cioè la forma di Levi è definita positiva in ogni suo punto;
...
considerata sull'insieme $\{(z,w)\in\mathbb{C}^2\mid -A<\mathfrak{Re}w<\beta\}$. Si verifica che $\rho$ è una funzione $C^2$ avente l'ipersuperficie reale $\partial\Omega\cap\{(z,w)\in\mathbb{C}^2\mid -A<\mathfrak{Re}w<\beta\}$ come luogo di zeri. Calcoliamo le seguenti derivati parziali seconde:\marginpar{È falso: -1/2. Così si rompe tutto}
\begin{gather*}
