...
\begin{proof}
    ...
    Poiché $\gamma([0,1])$ è compatto in $X$, per i punti (2) e (3) della Proposizione \ref{metrica_bilip} e per l'Osservazione \ref{basta_herm} esiste $C>0$ tale che
...
\begin{lm} \label{quasiovvio}
    Sia $X$ una varietà complessa\marginpar{E connessa? Da sistemare con la def di simil-geodetica}. Se $\sigma:[a,b] \longrightarrow X$ è una $(1,\kappa)$-simil-geodetica per qualche $\kappa>0$, allora per ogni $t \in [a,b]$ si ha
