...
\begin{proof}
    ...
    Poiché $\sigma_n(0)$ e $\sigma_n(T_n)$ convergono a punti del bordo finale, per $n$ sufficientemente grande appartengono a $X\setminus H$. Ma $\sigma_n(t_n)\in K\subseteq{\mathop H\limits^ \circ}$; quindi deve esistere $t_n'$ tale che $\sigma_n(t_n')\in\partial^\text{top}H$. Segue che
    \begin{align*}
