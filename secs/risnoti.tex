...
\begin{defn} \label{lung_X}
    Sia $X$ una varietà complessa e connessa\marginpar{In questa def e nel teorema successivo, non mi pare che serva imporre che $X$ sia una sottovarietà; si snelliscono così un po' di ipotesi più avanti}, e consideriamo una curva $\gamma:[a,b] \longrightarrow X$ tale che la funzione $K_X\big(\gamma(\cdot);\gamma'(\cdot)\big)$ sia integrabile su $[a,b]$. La \textit{lunghezza di $\gamma$ in $X$ rispetto alla pseudometrica di Kobayashi} è
