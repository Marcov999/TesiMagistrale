...
Citiamo ora un risultato che lega pseudometrica e pseudodistanza di Kobayashi; per una dimostrazione si rimanda a \cite{R}. \marginpar{controllare, forse c'è da citare anche un altro articolo}
...
\begin{oss}
    Non è difficile vedere che dal Teorema \ref{lung_int} segue che ogni varietà $X$ con quelle ipotesi è uno \textit{spazio di lunghezze} nel senso di \cite[Part I, Paragraph 3]{BH}.
\end{oss}
