...
\begin{prop}
    Siano $Y$ una varietà taut e $X\subset\subset Y$ una sottovarietà complessa relativamente compatta. Allora $X$ è tautly embdedded in $Y$.
\end{prop}
