...
\begin{thm}
    (\cite[Chapter 1, Proposition 6]{N}) Sia $\Omega \subseteq \mathbb{C}^n$ un dominio. Sia $\mathcal{F}$ una famiglia uniformemente limitata sui compatti; allora è relativamente compatta in $\mathcal{O}(\Omega)$.
\end{thm}
...
\begin{ex}
    ...
    In particolare, le funzioni limite di $f$ non sono né costanti né in $\text{Hol}(\Omega,\Omega)$, e questo è un controesempio, senza l'ipotesi taut, per il risultato di tipo Wolff-Denjoy che vedremo nella prossima sezione. BISOGNA ANCHE DIRE CHE SODDISFA LA CONDIZIONE DI VISIBILITÀ
\end{ex}
